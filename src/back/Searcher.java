...
public class Searcher {
  ...
  /** Simple command-line based search demo. */
  public static void search(String query, boolean stemming, boolean stopword) throws Exception {
		...
		{
			index = ".\\indexed";
			analyzer = new StandardAnalyzer(Version.LUCENE_CURRENT,new CharArraySet(Version.LUCENE_CURRENT, 0, false));	
		}else if(!stopword && stemming)
		{
			...
			analyzer = new EnglishAnalyzer(Version.LUCENE_CURRENT,new CharArraySet(Version.LUCENE_CURRENT, 0, false));
